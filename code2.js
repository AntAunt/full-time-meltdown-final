...
{for(var i = 0, len = gdjs.Game3Code.GDIgnoreTimeObjects1.length ;i < len;++i) {
    gdjs.Game3Code.GDIgnoreTimeObjects1[i].setString("NO Timeout Game Over: " + gdjs.evtTools.common.toString(gdjs.evtTools.common.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(3))));
}
}{for(var i = 0, len = gdjs.Game3Code.GDIgnoreDamageObjects1.length ;i < len;++i) {
    gdjs.Game3Code.GDIgnoreDamageObjects1[i].setString("NO Zero Lives Game Over: " + gdjs.evtTools.common.toString(gdjs.evtTools.common.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(4))));
}
}{for(var i = 0, len = gdjs.Game3Code.GDIgnoreEnemyObjects1.length ;i < len;++i) {
    gdjs.Game3Code.GDIgnoreEnemyObjects1[i].setString("NO Player Reset from Damage: " + gdjs.evtTools.common.toString(gdjs.evtTools.common.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(5))));
}
}}
...
gdjs.Game3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8434068);
}
}}
}
}
...
gdjs.Game3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8436396);
}
}}
if (gdjs.Game3Code.condition1IsTrue_0.val) {
/* Reuse gdjs.Game3Code.GDBluePlayerObjects1 */
...
gdjs.Game3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8438028);
}
}}
}
if (gdjs.Game3Code.condition2IsTrue_0.val) {
